...
import 'package:CovidThai/mainpage/profile.dart';
import 'package:CovidThai/mainpage/articles.dart';
                ...
                children: <Widget>[
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      setState(() {
                        currentScreen =
                            Articles(); // if user taps on this dashboard tab will be active
                        currentTab = 1;
                      });
                    },
                    child: Column(
